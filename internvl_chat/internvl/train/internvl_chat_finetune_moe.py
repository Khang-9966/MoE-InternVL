...
from internvl.model.internvl_chat import (InternVisionConfig,
                                          InternVisionModel)
from internvl.model.internvl_chat import MoeInternVLChatConfig as InternVLChatConfig
from internvl.model.internvl_chat import MoeInternVLChatModel as InternVLChatModel 
...
def main():
    ...
    if model_args.model_name_or_path is not None:
        ...
        #     config=config
        # )
        model.language_model.lm_head.weight = torch.nn.Parameter(model.language_model.model.embed_tokens.weight.detach().bfloat16())
    else:
